        ...
        {activeTab === 'orders' ? (
          ...
          <div>
            <div className="flex justify-end mb-4">
              <button className="bg-[#2C3E50] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#34495E] flex items-center gap-2">
                <Plus size={16} />
                Add Product
              </button>
            </div>
            <div className="bg-white shadow overflow-hidden sm:rounded-md p-4 text-center text-gray-500">
              Product management coming soon (Database dependent).
            </div>
          </div>
        )}
      </main>
